...
# person1_image = face_recognition.load_image_file("ImagesBasics/Elon_test.jpg")
# print(person1_image)
# person1_face_encoding = face_recognition.face_encodings(person1_image)[0]

# # โหลดภาพ Stop.jpg และให้ระบบจดจำใบหน้า
# person2_image = face_recognition.load_image_file("ImagesBasics/Nicha.jpg")
...
#                 # faceDistance = face_recognition.face_distance(known_face_encodings, encodeTest)
#                 print(faceDistance)
